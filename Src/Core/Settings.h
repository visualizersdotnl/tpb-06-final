...
#define PIMP_BACKBUFFER_FORMAT_GAMMA	DXGI_FORMAT_B8G8R8A8_UNORM_SRGB //< sRGB colorspace backbuffer format (which is actually used for the created swap chain)
